...
function generatePassword() {
  var passwordstring = ""
  var passwordlength = prompt("Choose password length must be between 8 and 128 characters")
  while (isNaN(passwordlength)||passwordlength< 8||passwordlength>128) {
    alert("password link must be a number between 8 and 128")
    passwordlength = prompt("Choose password length must be between 8 and 128 characters")
  }
